...
This study was conducted using only 18 out of 27 targets. All nine targets with alignment depths of $<100$ in the Pfam \gls{msa} were excluded (\cref{table:appendix_dataset_predictors}).
...
The addition of BBCONTACTS to existing sets of contacts was achieved with the FADE function in an identical manner as described in \cref{chap:proof_of_principle}. In comparison, the SCALARWEIGHTED term in the GREMLIN implementation of the SIGMOID energy function \cite{Ovchinnikov2015-tn} was multiplied by the number of occurrences of each contact pair in the combined map.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{ample_predictors_1u61_c2_t70_r1_reliable.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{ample_predictors_1fvg_gbb_phaser_c1_t25_r3_polyAla.png}

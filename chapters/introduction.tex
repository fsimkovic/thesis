...
% diffraction from molecular crystal
% sentence about proportionality of signal with increasing numbers of unit cells when diffraction from crystal
% structure factors

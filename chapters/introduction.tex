...
Other techniques to retrieve the lose phase information include Direct Methods and Experimental Phasing approaches \cite{Rupp2010-nc}. However, neither of these methods are relevant in this work, and thus will not be discussed further.

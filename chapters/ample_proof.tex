...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{ample_proof_rmsdtlevelsros.pdf}
        \caption{}
        \label{fig:ample_proof_rmsdtlevelsros}
    \end{subfigure}
    
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{ample_proof_rmsdtlevels.pdf}
        \caption{}
        \label{fig:ample_proof_rmsdtlevels}
    \end{subfigure}

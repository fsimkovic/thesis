...
\subsection{Assessment of Flib data}
% - MAE --> absolute difference between predicted and observed means
% - Precision --> Fragments with $<1.5$\AA classed as \gls{tp} otherwise \gls{fp}
% - Coverage --> Proportion of residues with at least one fragment
% - RMSD --> link to main page

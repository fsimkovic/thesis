...
\subsection{ETHERWOOD dataset} \label{sec:methods_dataset_etherwoo}

% =====================================================================

The selection of this dataset was done by \cite{Thomas2017-lq}. In summary, 14 non-redundant transmembrane protein targets were selected from the \gls{pdbtm} \cite{Tusnady2005-lp}, with a chain length of $<250$ residues and resolution of $<2.5$\AA. The final selection is summarised in \cref{table:methods_keeno_dataset}.
